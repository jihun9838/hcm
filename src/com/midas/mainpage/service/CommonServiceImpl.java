...
public class CommonServiceImpl implements CommonService{
	...
	/*
	 * @Override public Parent lookWindow(Stage s, String formPath) { FXMLLoader
	 * loader = new FXMLLoader(getClass().getResource(formPath)); Parent root =
	 * null; try { root = loader.load();
	 * 
	 * } catch (IOException e) { e.printStackTrace(); } return root; }
	 */
